<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sharefb.aspx.cs" Inherits="chiase" %>
    ...
    <meta id="idOgIitle" property="og:title" content="[Trắc nghiệm] Bạn là người thế nào trong công việc?" />
     <% 
      ...
      string titleR="";
         ...
         String img= String.Format(" <meta id='idOgImg' property='og:image' content='https://event.enschannel.com/source/thum-fb-{0}t.jpg' />",Request.Params["ia"]);
         %>
       <%Response.Write(wurl); %> 
   <%Response.Write(img); %> 
     <%Response.Write(desc); %> 
